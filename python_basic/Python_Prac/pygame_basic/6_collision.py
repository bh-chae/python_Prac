...
# 적 Enemy 캐릭터
enemy = pygame.image.load("/Users/bh_chae/hello_world/Python_Prac/pygame_basic/enemy.png")
enemy_size = enemy.get_rect().size # 이미지 크기
enemy_width = enemy_size[0] #가로
enemy_height = enemy_size[1] #세로
enemy_x_pos = screen_width/2 - enemy_width/2 # 화면 절반에 해당하는 곳에 위치
enemy_y_pos = screen_height/2 - enemy_height/2 #화면 세로크기에 가장아래


# 이벤트 루프
running = True 
while running:
    dt = clock.tick(60) #게임 화면 초당 프레임 수 설정
